...
<body style="margin:0; padding:0; background-color:#FAF6EE; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif; color:#1A1A1A;">
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color:#FAF6EE;">
        <tr>
            <td align="center" style="padding:32px 16px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width:560px; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 20px rgba(0,0,0,0.04);">
                    ...
                    <!-- Header (brand bar) -->
                    <tr>
                        <td style="background:linear-gradient(135deg,#C0281A 0%,#7F1B11 100%); padding:32px 32px 24px;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td style="background:#ffffff; width:44px; height:44px; border-radius:10px; text-align:center; vertical-align:middle; font-family:'Georgia',serif; font-size:24px; font-weight:bold; color:#C0281A;">A</td>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <h1 style="margin:0 0 16px; font-size:22px; font-weight:bold; color:#1A1A1A;">Reset your password</h1>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:24px 0;">
                                <tr>
                                    <td align="center" style="background:#C0281A; border-radius:10px;">
                                        <a href="{{ $resetUrl }}"
                            ...
                            <p style="margin:0 0 24px; font-size:13px; line-height:1.5; word-break:break-all;">
                                <a href="{{ $resetUrl }}" style="color:#C0281A; text-decoration:underline;">{{ $resetUrl }}</a>
                            </p>

                            <!-- Security note -->
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background:#FAF6EE; border-radius:10px; margin-top:8px;">
                                <tr>
                                    <td style="padding:16px;">
                                        <p style="margin:0; font-size:13px; line-height:1.5; color:#525252;">
                                            <strong style="color:#1A1A1A;">⏱ Link expires in {{ $expiresInMinutes }} minutes.</strong>
                    ...
                    <!-- Footer -->
                    <tr>
                        <td style="padding:24px 32px; background:#FAF6EE; text-align:center;">
                            <p style="margin:0 0 6px; font-size:12px; color:#737373;">
                                Need help? Reply to this email or message us on
                                <a href="https://wa.me/233500000000" style="color:#C0281A; text-decoration:none;">WhatsApp</a>.
                            </p>
